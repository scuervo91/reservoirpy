...
def petrophysics(logs,dfrom,dto,
    ...
    if sw_kw is not None:
        ...
        for i,method in enumerate(methods):
            logf[sw_cols_name[i]] = sw(logf[rt_col_name],logf[phi_col_name],rw,method=method, **sw_kw)
    ...
    if perm_kw is not None:
        ...
        for i,author in enumerate(authors):
            logf[perm_cols_name[i]] = perm(logf[phi_col_name],swir,author=author,**perm_kw)
